...
It is an individual assignment to help student understand
    ...
    * Built physics in a 3D environment, includinding Gravity, Turbulance Force and Impulse Force
    * Built Octree from scratch for terrain and detecting input rays
    * Used rays for collision detection
    * Built 3D models using Autodesk Maya and animation using Unity
    * Implemented 3D lighting system to lit up the scene
    * Set cameras for the scene as well as tracking the object
    * Practiced article collisions between two 3D object
